...
module.exports = {
  rules: {
    ...
    'ja-nakaguro-or-halfwidth-space-between-katakana': moduleInterop(
      require('textlint-rule-ja-nakaguro-or-halfwidth-space-between-katakana'),
    ),
    ...
    'prefer-tari-tari': moduleInterop(
      require('textlint-rule-prefer-tari-tari'),
    ),
    ...
    'no-insert-re': moduleInterop(
      require('@textlint-ja/textlint-rule-no-insert-re'),
    ),

    // い抜き言葉を検出する 例) 開発してます。
    'no-dropping-i': moduleInterop(
      require('@textlint-ja/textlint-rule-no-dropping-i'),
    ),
